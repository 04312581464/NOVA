...
# Constants
YOUTUBE_API_KEY = "AIzaSyAFi0T5--F9i-JM8jtbZ3on_fYZbl0rXBw"
GMAIL_USER = "ankitsingh14175@gmail.com"
GMAIL_PASSWORD = "zisn kydb qysb yifr"
...
# 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
import os
import aiohttp
import asyncio
import pyautogui
...
async def generate_and_type_code(prompt: str, filename: str, language: Optional[str] = None) -> str:
    ...
    try:
        ...
        GROQ_API_KEY = os.getenv("GROQ_API_KEY", "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")
